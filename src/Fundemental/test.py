...
class MyEmail:
    ...
    def get_attach(self):
        ...
        if self.user is not None:
            # 显示在发件人
            attach["From"] = "Kaiya Xiong<%s>" % self.user
        if self.to_list:
            # 收件人列表
...
if __name__ == "__main__":
    ...
    my.user = "me@kaiyai.com"
    my.passwd = "Applexiongkaiya123"
    my.to_list = ["xiongkaiya@gmail.com", "ixky@msn.com", "kaiya@mail.com"]
    # my.cc_list = ["xx@lxxx.com", "<span style="font - family: Arial, Helvetica, sans - serif;
    # ">xx@xxx.com</span>"]
    my.tag = "tag or title?"
